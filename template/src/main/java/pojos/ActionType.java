...
public enum ActionType implements Serializable{
    ...
    PROTECT_PAR("Protect the person according to PAR rule. \n\t\t\tEnsure the safety of yourself, the patient, and bystanders. \n\t\t\tMove the patient away from any immediate danger if possible. \n\t\t\tWear a reflective vest and put warning triangles. \n\t\t\tCall medical emergencies services"),
    RESCUE_PAR("Rescue the person according to PAR rule. \n\t\t\tRefrain from relocating the person or removing their helmet, shield them from cold or heat, abstain from providing food or drinks"),
